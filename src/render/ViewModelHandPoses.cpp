...
constexpr std::array<ViewModelHandPose, kWeaponCount> kPoses = {{
  // Lightning gun
  {true, {{-0.18F, 0.10F, 0.06F}, {-1.48F, 0.03F, 0.12F}}, true, {{0.06F, -0.12F, 0.06F}, {-1.43F, -0.05F, -0.16F}}},
  // Railgun
  {true, {{-0.18F, 0.10F, 0.06F}, {-1.46F, 0.06F, 0.16F}}, true, {{0.08F, -0.12F, 0.06F}, {-1.40F, -0.08F, -0.20F}}},
  // Rocket launcher
  {true, {{-0.18F, 0.10F, 0.06F}, {-1.44F, 0.09F, 0.10F}}, true, {{0.08F, -0.12F, 0.06F}, {-1.38F, -0.10F, -0.22F}}},
  // Machine gun
  {true, {{-0.18F, 0.10F, 0.06F}, {-1.47F, 0.04F, 0.14F}}, true, {{0.06F, -0.12F, 0.06F}, {-1.41F, -0.06F, -0.18F}}},
  // Shotgun
  {true, {{-0.18F, 0.10F, 0.06F}, {-1.45F, 0.05F, 0.18F}}, true, {{0.08F, -0.12F, 0.06F}, {-1.39F, -0.09F, -0.22F}}},
  // Grenade launcher
  {true, {{-0.18F, 0.10F, 0.06F}, {-1.42F, 0.10F, 0.11F}}, true, {{0.06F, -0.12F, 0.06F}, {-1.37F, -0.08F, -0.17F}}},
  // Plasma gun
  {true, {{-0.18F, 0.10F, 0.06F}, {-1.46F, 0.06F, 0.15F}}, true, {{0.06F, -0.12F, 0.06F}, {-1.39F, -0.07F, -0.19F}}},
  // Freeze gun
  {true, {{-0.18F, 0.16F, 0.04F}, {-1.49F, 0.03F, 0.18F}}, true, {{0.04F, -0.16F, 0.04F}, {-1.37F, -0.10F, -0.23F}}},
  // Revolver: a one-handed first pass keeps the silhouette intentional.
  {true, {{-0.18F, 0.10F, 0.05F}, {-1.50F, 0.10F, 0.24F}}, false, {}},
}};

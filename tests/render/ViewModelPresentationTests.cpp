...
int main() {
  ...
  const lg::ViewModelPresentationInput active{{8.0F, 3.0F, 0.0F}, 18.0F, -9.0F, true, 1.0F / 60.0F};
  ...
  (void)airborneOutput;
  lg::ViewModelPresentationInput landed{{0.0F, 0.0F, 0.0F}, 0.0F, 0.0F, true, 1.0F / 60.0F};

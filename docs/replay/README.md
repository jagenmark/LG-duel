...
The system has a bot-free v7 format, recorder, headless playback runner,
...
| `.lgdemo` v7 sparse-slot encoder/decoder and canonical hash | Implemented; v1 through v6 are rejected; decoded native allocations are capped; covered by `lg_duel_replay_codec_tests` |

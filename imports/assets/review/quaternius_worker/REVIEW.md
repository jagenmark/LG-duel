...
- The packet saves the Quaternius source page and seals it in the review manifest.
- `reports/input-bindings.json` seals the five FBX files used by Blender.
- `previews/` holds fixed stills for the two-handed idle and seven move clips, plus front and angle views.
